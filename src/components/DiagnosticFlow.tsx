...
import { Mic, Send, Brain, Activity, CheckCircle, AlertTriangle, RotateCcw, Stethoscope, Target, Sparkles, Heart } from 'lucide-react';
      ...
      <div className="max-w-4xl w-full mx-auto px-6">
        <div className="text-center space-y-12">
          ...
          <div className="relative">
            <div className="absolute inset-0 w-40 h-40 bg-gradient-to-r from-blue-400/30 to-purple-600/30 rounded-full blur-3xl animate-pulse mx-auto"></div>
            <div className="relative w-32 h-32 bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-600 rounded-3xl flex items-center justify-center mx-auto shadow-2xl">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-2xl text-gray-600 dark:text-gray-300 font-light max-w-3xl mx-auto leading-relaxed">
                Advanced medical analysis powered by artificial intelligence
              </p>
              <p className="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
                Describe your symptoms and receive personalized health insights through intelligent questioning
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <Stethoscope className="h-8 w-8 text-blue-500 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Medical Analysis</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">AI-powered symptom assessment</p>
              </div>
              <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <Target className="h-8 w-8 text-indigo-500 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Smart Questions</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Targeted follow-up inquiries</p>
              </div>
              <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <Sparkles className="h-8 w-8 text-purple-500 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Instant Results</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Real-time health insights</p>
              </div>
            </div>
            ...
            <Button 
              ...
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-12 py-6 text-xl font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            >
  ...
  const renderSymptomsStep = () => (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20 py-12">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-12">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Health Assessment</h2>
        ...
        {/* Main Content */}
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-white/20">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <Textarea
                ...
                placeholder="Example: I've been experiencing persistent headaches for the past 3 days, along with fatigue and mild nausea. The pain is more intense in the morning and seems to worsen with bright lights..."
                className="min-h-[200px] text-lg p-6 rounded-2xl border-2 border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm resize-none"
                rows={8}
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <select className="w-full p-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 bg-white/80 dark:bg-gray-700/80 text-lg focus:border-blue-500 dark:focus:border-blue-400 backdrop-blur-sm">
            ...
            <Button 
              ...
              size="lg"
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-6 text-xl font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300"
            >
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
      <div className="max-w-2xl w-full mx-auto px-6">
        <div className="text-center space-y-12">
          {/* Animated Icon */}
          <div className="relative">
            <div className="absolute inset-0 w-40 h-40 bg-gradient-to-r from-blue-400/30 to-indigo-600/30 rounded-full blur-3xl animate-pulse mx-auto"></div>
            <div className="relative w-32 h-32 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center mx-auto shadow-2xl">
              <Activity className="h-16 w-16 text-white animate-pulse" />
            </div>
            <div className="absolute inset-0 w-32 h-32 border-4 border-blue-200 dark:border-blue-700 rounded-full animate-ping mx-auto"></div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-xl mx-auto leading-relaxed">
              Our advanced AI is processing your symptoms and medical knowledge to provide accurate insights
            </p>
          </div>
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">Processing medical data...</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-12">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20">
            ...
            <Progress value={progress} className="h-3 rounded-full mt-4" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  {currentQuestion.type === 'yes_no' && (
                    <div className="grid grid-cols-2 gap-6">
                      <Button 
                        ...
                        size="lg"
                        className="bg-gradient-to-br from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white py-8 text-xl font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
                      >
                      ...
                      <Button 
                        ...
                        size="lg"
                        className="bg-gradient-to-br from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white py-8 text-xl font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
                      >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/20 sticky top-6">
              ...
              <div className="space-y-4 max-h-[70vh] overflow-y-auto">
                {diseases.sort((a, b) => b.confidence - a.confidence).map((disease, index) => (
                  <div key={disease.id} className={`p-4 rounded-2xl transition-all duration-300 ${
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20 py-12">
        <div className="max-w-5xl mx-auto px-6">
          {/* Header */}
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-green-500 to-emerald-600 rounded-3xl shadow-2xl mb-6">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4">
                  {sortedDiseases.map((disease, index) => (
                    <div key={disease.id} className="flex justify-between items-center p-4 bg-white/70 dark:bg-gray-700/50 rounded-xl">
                      <div className="flex items-center space-x-4">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 border-2 border-orange-200 dark:border-orange-700 rounded-2xl p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-orange-800 dark:text-orange-200 text-lg mb-2">
